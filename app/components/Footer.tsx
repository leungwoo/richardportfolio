    ...
    <div className="flex flex-col items-center justify-center pb-10">
      <div className=" relative">
        <div className=" md:gap-5 gap-3 absolute flex flex-col flex-wrap min-w-[200px] md:top-0 top-2 left-0 right-0 bottom-0 items-center justify-center">
          <span className="text-xs sm:text-xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-text-title">
            Have a project idea to{" "}
            <div className="relative inline-block">
              <span className="z-10 relative text-xs sm:text-xl md:text-3xl lg:text-4xl xl:text-5xl text-text-title font-bold dark:text-white">
                collaborate on?
              </span>
