    ...
    <div className=" md:pt-[80px]  flex md:flex-row flex-col bg-primary-Default dark:bg-primary-darkDefault min-h-screen">
      <div className="flex-1 md:pl-20 px-4 pt-20 space-y-5">
        ...
        <div className="flex flex-row mt-4 items-center">
          <Link href="/Contact">
            <button className="hover:opacity-75 border-none bg-text-accentBlue font-bold rounded-full md:w-[186px] w-[120px] md:h-[64px] h-[55px] py-4 px-3 text-white text-sm md:text-base">
              Contact Us
            </button>
          </Link>
          <div className="pl-6">
